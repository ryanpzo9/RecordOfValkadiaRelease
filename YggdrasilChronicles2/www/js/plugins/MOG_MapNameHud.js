...
/*:
 * @plugindesc (v1.2) Apresenta uma Hud com o nome do mapa.
 * @author Moghunter
 *
 * @param Hud X-Axis
 ...
 * HISTÓRICO
 * =============================================================================
 * (v1.2) - Correção do bug de não apagar a hud do mapa ao entrar em mapas
 *          sem nomes.
...
// * Create Upper Layer
//==============================
var _mog_mhud_sprmap_createUpperLayer = Spriteset_Map.prototype.createUpperLayer;
Spriteset_Map.prototype.createUpperLayer = function() {
    _mog_mhud_sprmap_createUpperLayer.call(this);
	this.createMapNameSprite();
};

//==============================
// * Create Map Name Sprite
//==============================
Spriteset_Map.prototype.createMapNameSprite = function() {

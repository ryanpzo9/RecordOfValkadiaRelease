...
Yanfly.EvReTr.version = 1.00;

//=============================================================================
 /*:
 * @plugindesc v1.00 Allows events to trigger by being in specific regions
...
Game_Event.prototype.meetEventRegionTriggerConditions = function() {
  ...
  if (!this._regionTriggerList) return false;
  if (this._regionTriggerList.length <= 0) return false;

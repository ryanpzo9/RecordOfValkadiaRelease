...
function MakerManager() {
	throw new Error('You silly-billy, MakerManager is a static class! (ï½¡â€¢̀€á´—-)âœ§');
}

function FileManager() {
	throw new Error('Hey, noob! FileManager is a static class! ăƒ¾(Đ¾-Ï‰ï½¥)ï¾‰âŒ’â˜…');
}

function DataManagerEX() {
	throw new Error('It doesn\'t matter how extreme, DataManagerEX is a static class! (â•¬Ă’^Ă“)');
}
...
function WindowManager() {
	throw new Error('Great job. WindowManager is a static class! Ê•Â·á´¥Â·ă€€Ê”');
}

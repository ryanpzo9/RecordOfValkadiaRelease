 ...
 * @author トリアコンタン (Triacontane - https://triacontane.blogspot.jp)
 *
 * @help We extend the expression method of Butler images during battle.
 * You can float in the air, change color tones and sizes, and express a variety of colors.
 *
 * Please describe in the notes column of the database having features as follows.
 *
 * Float the Battler. This setting is effective only for actors.
 * <BGEAltitude:n> n:Altitude(pixel)
 *
 * Set the battler's opacity.
 * <BGEOpacity:n> n:Opacity(0..256)
 *
 * Set the battler's color tone. Specify each element numerically.
 * <BGETone:r,g,b,g> r:赤 g:緑 b:青(-255..255) g:グレー(0..255)
 * For example:<BGETone:255,255,255,128>
 *
 * Flashes the battler gently. Specify each element numerically.
 * This process is a bit heavy, so please be careful when running on mobile.
 * <BGEFlash:r,g,b,a> r:赤 g:緑 b:青 a:強さ(0..255)
 * For example:<BGEFlash:255,0,0,128>
 *
 * If you want to change the flash interval. The smaller the flash interval, the faster the flashing, the default is 15.
 * <BGEFlashInterval:f> f:Number of frames
 * For example:<BGEFlashInterval:30>
 *
 * Set the battler's blend method.
 * <BGEBlendMode:n> n:0[Normal] n:1[Addictive] n:2[Multiply] n:3[Screen]
 *
 * Set the scale rate of the battler.
 * <BGEScaleX:n> n:Scale(100%)
 * <BGEScaleY:n> n:Scale(100%)
 * For example:<BGEScaleY:150>
 *
 * Set the battler's motion speed.
 * This setting is effective only for actors.
 * <BGEMotionRate:n> n:Rate(100%)
 * For example:<BGEMotionRate:150>
 *
 * This plugin is released under the MIT License.
 */
/*:ja
 * @plugindesc Battler graphic display extension plug-in
 * @author トリアコンタン (Triacontane - https://triacontane.blogspot.jp)
 *
 * @help We extend the expression method of Battler images during battle.

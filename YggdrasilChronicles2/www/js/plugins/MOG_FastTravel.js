...
//=============================================================================
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_FastTravel');
	...
	Moghunter.fastTravel_TotalMaps = Number(Moghunter.parameters['Total Maps'] || 10);
	for (var j = 1; j <= Moghunter.fastTravel_TotalMaps; j++){
		Moghunter.mapName[j] = String(Moghunter.parameters['Map Name ' + j] || Moghunter.mapName[j]);
		Moghunter.mapID[j] = Number(Moghunter.parameters['Map ID ' + j] || 0);
		Moghunter.mapX[j] = Number(Moghunter.parameters['Map X ' + j] || 0);
		Moghunter.mapY[j] = Number(Moghunter.parameters['Map Y ' + j] || 0);
		Moghunter.playerDir[j] = Number(Moghunter.parameters['Direction ' + j] || 2);
	}
//=============================================================================
// ** ImageManager
//=============================================================================
...
// ** TOWNS
//=============================================================================	
	for (var i = 1; i <= Moghunter.fastTravel_TotalMaps; i++){
		Moghunter.fastTravel_Towns[i] = {name:Moghunter.mapName[i],x:0,y:0,mapID:Moghunter.mapID[i],mapX:Moghunter.mapX[i],mapY:Moghunter.mapY[i],direction:Moghunter.playerDir[i]};
	}
	//Moghunter.fastTravel_Towns[1] = {name:"Summerbreeze Town",x:0,y:0,mapID:4,mapX:22,mapY:14,direction:8};
    //Moghunter.fastTravel_Towns[2] = {name:"Religia City",x:0,y:0,mapID:13,mapX:48,mapY:22,direction:2};
    //Moghunter.fastTravel_Towns[3] = {name:"Seagull Port",x:0,y:0,mapID:24,mapX:23,mapY:37,direction:2};
	//Moghunter.fastTravel_Towns[4] = {name:"Lost Forest",x:0,y:0,mapID:20,mapX:29,mapY:45,direction:2};

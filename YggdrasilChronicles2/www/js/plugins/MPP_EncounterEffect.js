...
/*:
 * @plugindesc 【ver.1.2】Change appearance of how the battle start with dynamic effects.
 * @author Mokusei Penguin
 *
 * @help Plugin Command:
 *   EncEffChar evId             # Character that's center of the effect
 *   EncEffColor r g b           # Change effect color
 *   EncEffType type             # Change screen cracking method
 * 
 * ※ Variables can be used for the value specified by the plug-in command.
 *    v[n] which refers the value of variable n
 * 
 * ================================================================
 * ▼Plugin Command Details
 * --------------------------------
 *  〇EncEffChar evId
 *      evId : ID of an event that's center of the effect
 *  
 *   Only the next occurrence of event ID specified by the effect
 *   Mostly focused on characters.
 *   
 *   If 0 is specifiec, [this event]
 *   When you input -1, indicates [player]
 *    
 * --------------------------------
 *  〇EncEffColor r g b
 *      r g b : Effect RGB color code 
 *  
 *   An effect changed to the color specified.
 *    
 * --------------------------------
 *  〇EncEffType type
 *      type : Screen break
 *  
 *   Change how the screen breaks to certain type.
 * 
 * ================================================================
 * ▼Plugin Parameter Details
 * --------------------------------
 *  〇Break Type (Screen effect)
 *   -1 : Default encounter effect
 *   0  : Breaks into a triangle on the center of the character
 *   1  : Split into a rectangle on the center of the character
 *   
 * ================================================================
 * ▼Information
 *  〇Plugin focuses on Battle processing/ Event processing
 *  
 *  〇Some effects are omitted on mobile devices
 * 
 *  〇Plugin Command names can be changed for your convenience through plugin parameters
 * 
 * ================================
 * Author : Mokusei Penguin
 ...
 * @min -1
 * @max 1
 * @desc Screen break type (-1 = default, 0 = triangles, 1 = rectangles)
 * @default 1
 * 
 * @param Effect Duration
 * @type number
 * @min 1
 * @desc Effect time duration
 * @default 90
 * 
 * @param Default Color
 * @desc Default effect color
 * (rgb color code)
 * @default 255,255,255
 * 
 * @param Radial Number
 * @type number
 * @min 3
 * @desc Number radially divided
 * @default 10
 * 
 * @param Radial Random Rate
 * @desc Random numbers for radial division
 * (0～1)
 * @default 0.9
 * 
 * @param Circle Radius
 * @type number
 * @min 1
 * @desc Basic radius when dividing it into a circle
 * @default 96
 * 
 * @param Circle Increase Rate
 * @desc Increase rate of dividing into a circle
 * @default 1.5
 * 
 * @param Circle Random Rate
 * @desc Random number that divides into a circle
 * (0～1)
 * @default 0.4
 * 
 * @param === Command ===
 ...
 * @desc Effect that appears on the center of a character
 * @default EncEffChar
 * 
 * @param EncounterEffectColor
 * @desc Change color of the effect
 * @default EncEffColor
 * 
 * @param EncounterEffectType
 * @desc Set a type of encounter effect
 * @default EncEffType
 * 
 */

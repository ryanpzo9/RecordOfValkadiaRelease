 ...
 * @param Discard Sound
 * @parent ---General---
 * @desc Sound used when discarding item.
 * @default Evasion1
 *
 * @param Discard Sound Volume
 * @parent ---General---
 * @desc Volume of discarding sound.
 * @default 100
 *
 * @param Discard Sound Pitch
 * @parent ---General---
 * @desc Pitch of discarding sound.
 * @default 100
 *
 * @param Discard Sound Pan
 * @parent ---General---
 * @desc Pan of discarding sound.
 * @default 100
 *
...
Yanfly.Param.Sound = String(Yanfly.Parameters['Discard Sound']);
Yanfly.Param.Volume = Number(Yanfly.Parameters['Discard Sound Volume']);
Yanfly.Param.Pitch = Number(Yanfly.Parameters['Discard Sound Pitch']);
Yanfly.Param.Pan = Number(Yanfly.Parameters['Discard Sound Pan']);
...
Scene_Item.prototype.performDiscardItem = function(item, quantity) {
	var dsound = Yanfly.Param.Sound;
	var dvolume = Yanfly.Param.Volume;
	var dpitch = Yanfly.Param.Pitch;
	var dpan = Yanfly.Param.Pan;
	var mySe = {  name: dsound,  volume: dvolume,  pitch: dpitch,  pan: dpan};

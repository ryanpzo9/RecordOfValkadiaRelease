/*:
@author Chaucer
@plugindesc | Scene Stabilizer : Version - 4.1.2 | Stabilizes scenes on scene transfer.
@help
===============================================================================
 Introduction :
===============================================================================
...
//-----------------------------------------------------------------------------
    ...
    this._delta = 0;
    this._stabilizer = $.ticker;
    $.ticker.add( this.stabilityCheck, this );
  };

...
/*:
 * ==============================================================================
 * @plugindesc v2.03 - Customize the Damage Popup display.
 * @author Victor Sant
 *
 * @param == Basic Setup ==
 * @default ==============================
...
(function() {
    ...
    Sprite_Battler.prototype.setupDamagePopup = function() {
        if (this._battler.isDamagePopupRequested()) {
            if (this._battler.isSpriteVisible()) this.setupDamagePopupSprites();
    ...
    Sprite_Battler.prototype.addStatesPopup = function(states) {
        states.forEach(function(id) {
            ...
            if (!state.hidePopup.add) this.damagePopupSprite('State Add', value);
        }, this);
    };
    ...
    Sprite_Battler.prototype.removeStatesPopup = function(states) {
        states.forEach(function(id) {
            ...
            if (!state.hidePopup.rmv) this.damagePopupSprite('State Remove', value);
        }, this);
    };
...
(function() {
    ...
    Sprite_CustomDamage.prototype.setup = function(target, type, value) {
        ...
        if (this.damageDigits(type)) {
            if (value.resist) this.createText(value.resist);
            this.createDigits(type)
        }
        this.createText(type);
        this.setupDuration();

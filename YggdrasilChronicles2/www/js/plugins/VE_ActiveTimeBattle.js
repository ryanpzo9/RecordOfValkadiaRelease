...
Imported['VE - Active Time Battle'] = '1.02';
...
/*:
 * ==============================================================================
 * @plugindesc v1.01 - Changes the turn system to one based on time bars.
 * @author Victor Sant
 *
 * @param = ATB Setup = 
 * @default ======================================
...
(function() {
    ...
    VictorEngine.ActiveTimeBattle.processNotes1 = function(data) {
        ...
        while (match = regex1.exec(data.note)) {
            data.atbCast.speed = Math.max(Number(match[1]) / 100, 1);
    ...
    BattleManager.actor = function() {
        return this.partyCommandIsOpen() ? null : VictorEngine.ActiveTimeBattle.actor.call(this);
    };
